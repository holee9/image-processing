...
>
> **아직 남은 것**: 자동화 보고서가 Mock 폴백에서도 `Passed=True` 입니다 — CI 게이트가 그 값으로 판정하므로
> Native 를 검증하려는 실행이 Mock 으로 돌아도 초록일 수 있습니다(GUI-C-83 진행 중). 배너의 해제 불가는 구성으로만
> 보장됩니다(자동화 트리에 닫기 컨트롤이 노출되지 않음).
>
> <details><summary>이력: 2026-09-17 최초 측정 시점의 표시</summary>
>
