...
> **[#175] 통제 구현·검증 완료 (2026-09-17). 잔여 위험 등급은 재평가 대기.**
>
...
> | (3) 보고서 3종에 실제 모드 기록 | menu-command-report, automation report, 증거 묶음 | 미실측(파일로 확인 안 함) |
...
>
> **남은 것 — 통제 (3)**: 보고서 3종에 실제 모드가 기록되는지 **파일로** 확인하지 않았습니다. 사용자 결정(2026-09-17):
> 이것을 실측한 뒤 잔여 위험 등급을 확정하고 `#175` 를 닫습니다(GUI-C-85).
>
> <details><summary>이력: 2026-09-17 최초 측정 시점의 표시</summary>
>
