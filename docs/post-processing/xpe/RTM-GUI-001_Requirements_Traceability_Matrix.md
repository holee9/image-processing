...
| HAZ-GUI-004 (Stale preview) | ARCH-001 §4.3, DISP-INT-001 §4.3 | **E2E W-20~W-26** (메인·분리 뷰어, Mock+Native, CI `3537a13`) — 이전 표기 "W-06/W-07" 의 W-06 은 존재하지 않았음 (#171) |
| HAZ-GUI-005 (Misleading diagnostics) | ACCESS-001 §7, persistent warning | E2E E-01  — ⚠ **#175: 통제 (1)(2) 와 검증 E-01 이 코드에 없음 — 추적이 끊긴 상태** |
