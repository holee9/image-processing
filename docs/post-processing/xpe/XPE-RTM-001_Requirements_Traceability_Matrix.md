...
**Document ID:** XPE-RTM-001 v1.7  
**IEC 62304 Clause:** 5.1.1c, 5.3.6, 5.7.4, 7.3.3  
...
**VVP Ref** 열(v1.7 신설)은 각 SRS 요구사항의 검증 방법을 정의하는 V&V Plan 절을 가리킨다
(`VVP-PREPROCESS-001` / `VVP-P1B-001` / `XPE-VVP-P2ADV-001`). `—` 는 현재 어느 VVP addendum
에서도 다루지 않는 행이며, 코드가 없다는 뜻이 아니라 **검증 계획 문서가 없다**는 뜻이다.
`xpe_common`(SWU-5.x) 과 GUI(SWU-5.7) 는 전용 VVP addendum 이 없다.

| SRS Req ID | Arch (SAD) | Unit (SDD-001) | Design Detail (SDD-002) | Unit Test (STP-001) | Integration Test | System Test | Risk Ref | HAZ (SHA-001) | VVP Ref |
|-----------|:----------:|:----------:|:----------:|:---------:|:---------------:|:-----------:|:--------:|:--------:|:--------:|
| SRS-FUNC-001 | SWI-1 | SWU-1.1 | SDD-002 §2.1 | UT-1.1-001..005 | IT-001 | ST-001 | — | — | VVP-PREPROCESS-001 §3.1 |
| SRS-FUNC-002 | SWI-1 | SWU-1.2 | SDD-002 §2.2 | UT-1.2-001..006 | IT-001 | ST-002 | — | — | VVP-PREPROCESS-001 §3.1 |
| SRS-FUNC-003 | SWI-1 | SWU-1.3 | SDD-002 §2.3 | UT-1.3-001..008 | IT-001 | ST-003 | HAZ-003 | SHA §3 HAZ-003 | VVP-PREPROCESS-001 §3.1 |
| SRS-FUNC-004 | SWI-1 | SWU-1.4 | SDD-002 §2.4 | UT-1.4-001..006 | IT-001 | ST-004 | HAZ-004 | SHA §3 HAZ-004 | VVP-PREPROCESS-001 §3.1 |
| SRS-FUNC-010 | SWI-2 | SWU-2.1 | SDD-002 §3.1 | UT-2.1-001..003 | IT-002 | ST-010 | — | — | VVP-P1B-001 §4.1 |
| SRS-FUNC-011 | SWI-2 | SWU-2.2 | SDD-002 §3.2 | UT-2.2-001..005 | IT-002 | ST-011 | — | — | VVP-P1B-001 §4.1 |
| SRS-FUNC-012 | SWI-2 | SWU-2.3 | SDD-002 §3.3 | UT-2.3-001..006 | IT-002 | ST-012 | — | — | VVP-P1B-001 §4.1 |
| SRS-FUNC-013 | SWI-2 | SWU-2.4 | SDD-002 §3.4 | UT-2.4-001..004 | IT-002 | ST-013 | HAZ-005 | SHA §3 HAZ-005 | VVP-P1B-001 §4.1 |
| SRS-FUNC-014 | SWI-2 | SWU-2.5 | SDD-002 §3.5 | UT-2.5-001..008 | IT-002 | ST-014 | — | — | XPE-VVP-P2ADV-001 §4.1 |
| SRS-FUNC-015 | SWI-2 | SWU-2.6 | SDD-002 §3.6 | UT-2.6-001..004 | IT-002 | ST-015 | — | — | XPE-VVP-P2ADV-001 §4.2 |
| SRS-FUNC-016 | SWI-2 | SWU-2.7,2.8,2.10 | SDD-002 §3.7,3.8,3.10 | UT-2.7/2.8/2.10-* | IT-002 | ST-016 | — | — | XPE-VVP-P2ADV-001 §4.3, §4.4 |
...
| SRS-FUNC-020 | SWI-3 | SWU-3.1 | SDD-002 §4.1 | UT-3.1-001..003 | IT-003 | ST-020 | — | — | VVP-P1B-001 §4.1 |
| SRS-FUNC-021 | SWI-3 | SWU-3.2 | SDD-002 §4.2 | UT-3.2-001..005 | IT-003 | ST-021 | HAZ-006 | SHA §3 HAZ-006 | VVP-P1B-001 §4.1 |
| SRS-FUNC-022 | SWI-3 | SWU-3.3 | SDD-002 §4.3 | UT-3.3-001..006 | IT-003 | ST-022 | HAZ-007 | SHA §3 HAZ-007 | VVP-P1B-001 §4.1 |
| SRS-FUNC-023 | SWI-3 | SWU-3.3 | SDD-002 §4.3 | UT-3.3-003,005 | IT-003 | ST-023 | — | — | VVP-P1B-001 §4.1 |
| SRS-FUNC-024 | SWI-5 | SWU-5.7 | XPE-GUI-COMPARE-001 §4-7 | GUI-CMP-VER-001..006 | IT-GUI-CMP | ST-GUI-CMP | HAZ-009 | SHA §3 HAZ-009 | — |
| SRS-FUNC-030 | SWI-4 | SWU-4.1,4.2 | SDD-002 §5.1,5.2 | UT-4.1/4.2-001..008 | IT-003 | ST-030 | — | — | VVP-P1B-001 §4.1 |
| SRS-FUNC-031 | SWI-4 | SWU-4.3 | SDD-002 §5.3 | UT-4.3-001..004 | IT-003 | ST-031 | — | — | VVP-P1B-001 §4.1 |
| SRS-FUNC-032 | SWI-4 | SWU-4.2 | SDD-002 §5.2 | UT-4.2-002,004 | IT-003 | ST-030 | — | — | VVP-P1B-001 §4.1 |
...
| SRS-SAFE-003 | SWI-1,5 | SWU-1.3,5.3 | SDD-002 §2.3,6.3 | UT-1.3-008,UT-5.3-001 | IT-005,011 | ST-SAFE-003 | HAZ-003 | SHA §3 HAZ-003 | VVP-PREPROCESS-001 §3.3 |
| SRS-SAFE-004 | SWI-1,4 | SWU-1.4,4.2 | SDD-002 §2.4,5.2 | UT-1.4-006,UT-4.2-005 | IT-001 | ST-SAFE-004 | HAZ-004 | SHA §3 HAZ-004 | VVP-PREPROCESS-001 §3.1; VVP-P1B-001 §4.1 |
| SRS-SAFE-005 | SWI-2,5 | SWU-2.4,5.5 | SDD-002 §3.4,6.5 | UT-2.4-003..004,UT-5.5-002..003 | IT-002 | ST-SAFE-005 | HAZ-005 | SHA §3 HAZ-005 | VVP-P1B-001 §4.1 |
| SRS-SAFE-006 | SWI-3,5 | SWU-3.2,5.3 | SDD-002 §4.2,6.3 | UT-3.2-004..005 | IT-003 | ST-SAFE-006 | HAZ-006 | SHA §3 HAZ-006 | VVP-P1B-001 §4.1 |
| SRS-SAFE-007 | SWI-3,5 | SWU-3.3,5.3 | SDD-002 §4.3,6.3 | UT-3.3-002,004 | IT-003 | ST-SAFE-007 | HAZ-007 | SHA §3 HAZ-007 | VVP-P1B-001 §4.1 |
| SRS-SAFE-008 | SWI-2,3 | SWU-2.11,3.3 | SDD-002 §3.11,4.3 | UT-2.11-005,UT-3.3-007 | IT-002 | ST-SAFE-008 | HAZ-008 | SHA §3 HAZ-008 | VVP-P1B-001 §4.1 |
| SRS-SAFE-009 | SWI-3,5 | SWU-3.3,5.7 | SDD-002 §4.3,6.7 | UT-3.3-008,UT-5.7-002 | IT-003 | ST-SAFE-009 | HAZ-009 | SHA §3 HAZ-009 | VVP-P1B-001 §4.1 |
| SRS-SAFE-013 | SWI-5 | SWU-5.7 | XPE-GUI-COMPARE-001 §5-7 | GUI-CMP-VER-001..006 | IT-GUI-CMP | ST-SAFE-013 | HAZ-009 | SHA §3 HAZ-009 | — |
| SRS-PERF-001 | SWI-1 | All SWU-1.x | SDD-002 §2 | ST-PERF-001 | IT-010 | ST-PERF-001 | — | — | VVP-PREPROCESS-001 §5.1 |
| SRS-PERF-002 | All SWI | All SWU | SDD-002 §6.7 | — | IT-009 | ST-PERF-002 | — | — | — |
| SRS-PERF-003 | SWI-3 | SWU-3.2 | SDD-002 §4.2 | UT-3.2-interactive | IT-004 | ST-PERF-003 | — | — | VVP-P1B-001 §6.2 |
...
| 1.7 | 2026-09-10 | xpe-docs (issue #59) | §2 Forward Traceability 에 **VVP Ref** 열 추가 — 각 행을 VVP-PREPROCESS-001 / VVP-P1B-001 / XPE-VVP-P2ADV-001 의 검증 절에 연결. 대응 VVP 절이 없는 행(`—`): SRS-FUNC-017(SWU-2.9), -018(SWU-2.11/2.12), -024(GUI SWU-5.7), SRS-SAFE-001(SWU-5.1), -002(SWU-5.5), -013(GUI), SRS-PERF-002(전 SWU), -004(SWU-5.1), -007/-008(GUI). xpe_common(SWU-5.x)·GUI 는 전용 VVP addendum 이 없다. |

---

*Document End — XPE-RTM-001 v1.7*
