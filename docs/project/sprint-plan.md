...
2. Load precreated fixture `gui/ImageProcTest/fixtures/gui-s0/raw/synthetic_1024x1024.raw` (uint16 sample validated by fixture manifest) → image renders in canvas
