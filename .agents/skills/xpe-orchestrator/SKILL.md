...
Agent(
    ...
    model: "opus",
    prompt: """
    당신은 xpe-architect입니다. .Codex/agents/xpe/xpe-architect.md를 읽고 역할을 수행하세요.
...
Agent(
    ...
    model: "opus",
    prompt: """
    당신은 xpe-implementer입니다. .Codex/agents/xpe/xpe-implementer.md를 읽고 역할을 수행하세요.
    사용할 스킬: xpe-module-impl
...
Agent(
    ...
    model: "opus",
    prompt: """
    당신은 xpe-algorithm입니다. .Codex/agents/xpe/xpe-algorithm.md를 읽고 역할을 수행하세요.
...
Agent(
    ...
    model: "opus", 
    prompt: """
    당신은 xpe-qa입니다. .Codex/agents/xpe/xpe-qa.md를 읽고 역할을 수행하세요.
    사용할 스킬: xpe-testing
...
Agent(
    ...
    model: "opus",
    prompt: """
    당신은 xpe-docs입니다. .Codex/agents/xpe/xpe-docs.md를 읽고 역할을 수행하세요.
    사용할 스킬: xpe-iec62304
