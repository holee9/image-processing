...
| [XPE-ALG-001](docs/post-processing/xpe/XPE-ALG-001_Unified_Algorithm_Development_Specification.md) | **통합 알고리즘 개발 명세 v1.2** — IEC 62304 §5.4 Detailed Design. 3 라운드, 30개 GAP 완전 해소. 수식·Python 보정 코드·C++ AVX2 런타임·검증 기준 포함. (GAP-A~X: Offset/Gain/Ghost/NSCT/EI/AED/NPS/DQE/MTF/CollimMask/Heel/MultiSID/SessionLock/QualityState/ParityHarness/LagTiering/VGPresets/AIWorker/DriftMonitor) |
