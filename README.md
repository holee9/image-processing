...
| [XPE-ALG-001](docs/post-processing/xpe/XPE-ALG-001_Unified_Algorithm_Development_Specification.md) | **통합 알고리즘 개발 명세 v1.3** — IEC 62304 §5.4 Detailed Design. 4 라운드 40회 완료, 40개 GAP 완전 해소. 수식·Python 보정 코드·C++ AVX2 런타임·검증 기준 포함. v1.3 신규: Fluoroscopy IIR·BHC·GDC·BinningCal·MemArena·ThreadSPSC·AutoCNR·AutoWL·SigmaClip·ErrorTaxonomy (7,563줄) |
