...
## 프로젝트 완성도 현황 (2026-04-17)

두 개의 독립적인 점수 프레임워크로 완성도를 추적합니다.

| 프레임워크 | 기준 | 현재 | Phase 1b 완료 시 | 목표 |
|-----------|------|:----:|:---------------:|:----:|
| **A — Process/Compliance** | EARS 추적성, IEC 62304, 교차검증 이슈 해소 | **63 / 100** | ~76 | **85** |
...
- 네이티브 언어 기준: `C++17`
- 의존성 관리자: `vcpkg`
- 현재 CI 빌드 대상: `modules/common` (전체 모듈 로컬 빌드 가능)
- 현재 CI 테스트 대상: `tests/common_smoke` + `tests/common_unit` (86 cases)
