...
총 **15개 공개 API 함수 = api-spec.md Section 5.1–5.15 와 일치**. DLL export 는 16 — `xpe_alert_push`(구 `xpe_test_inject_alert`, #111 개명 완료; 알림 큐 생산자 export, api-spec §5.16) 가 추가로 있으며 REQ-P0-008 은 2026-09-09 에 16 으로 개정됐다 (#111).
