...
| N4 | Auto Exposure Detection functions header missing | Dev | xpe_common_api.h (Phase 0) |
...
| N3 | Auto Exposure Detection function docs | Tech Lead | api-spec.md v1.2.0 |
...
1. **api-spec.md v1.2.0**: Add multi-gain parameters, drift detection function, Auto Exposure Detection functions
